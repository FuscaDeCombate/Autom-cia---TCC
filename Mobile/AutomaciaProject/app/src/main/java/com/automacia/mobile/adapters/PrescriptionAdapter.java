...
public class PrescriptionAdapter extends RecyclerView.Adapter<PrescriptionAdapter.PrescriptionViewHolder> {
    ...
    static class PrescriptionViewHolder extends RecyclerView.ViewHolder {
        private final CardView cardPrescription;
        private final CardView statusIconCard;
        private final ImageView ivPrescriptionStatus;
        private final TextView tvPrescriptionTitle;
        private final TextView tvPrescriptionDate;
        private final TextView tvPrescriptionDoctor;
