    ...
    public partial class TelaLogin : Form
    {
        ...
        private void Login()
        {
            try
            {
                ...
                DataTable dt = objBanco.LoginFuncionario(id, senha);

                // Verificar se o login foi inválido
                if (dt.Columns.Count == 1)
                {
                    MessageBox.Show("Verifique as credenciais inseridas.", "Funcionário não identificado!!!");

                    // Deixar o TextBox do ID em Focus
                    TxtID.Focus();
                    return;
                }
                ...
                if (dt.Columns.Count > 1)
                {
                    ...
                    switch (Convert.ToInt32(dt.Rows[0]["ID_Tipo_Funcionario"]))
                    {
                    ...
                    if (objForm != null)
                    {
                        ...
                        Funcionario.Id = Convert.ToInt32(dt.Rows[0]["Funcionar_Rec"]);
                        Funcionario.IdTipo = Convert.ToInt32(dt.Rows[0]["ID_Tipo_Funcionario"]);
                        Funcionario.Cnpj = Convert.ToInt32(dt.Rows[0]["CNPJ"]);
                        Funcionario.Nome = dt.Rows[0]["Nome_Funcionario"].ToString();
