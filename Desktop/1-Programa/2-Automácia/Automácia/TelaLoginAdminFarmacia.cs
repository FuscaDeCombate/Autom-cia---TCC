    ...
    public partial class TelaLoginAdminFarmacia : Form
    {
        ...
        private void BtnEntrar_Click(object sender, EventArgs e)
        {
            ...
            if (cpf == "12345678910" && senha == "Senha123?")
            {
                ...
                objTelaFuncoesAdminFarmacia.Show();
                this.Hide();
            }
            else
            {
        ...
        private void TelaLoginAdminFarmacia_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!Sessao.saindo)
            {
        ...
        private void TelaLoginAdminFarmacia_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
