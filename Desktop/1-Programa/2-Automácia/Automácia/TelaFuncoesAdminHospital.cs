...
namespace Automácia
{
    public partial class TelaFuncoesAdminHospital : Form
    {
        ...
        private void TelaFuncoesAdminHospital_Load(object sender, EventArgs e)
        {
            ...
            FonteUtils.AplicarFonte(TxtVerCRM, "Inter-Regular", 12.5f, FontStyle.Regular);
            ...
            FonteUtils.AplicarFonte(LblVerCRM, "Inter-Bold", 16.5f, FontStyle.Bold);
        ...
        private void PnlTxtBoxVerCRM_Paint(object sender, PaintEventArgs e)
        {
            EstiloUtils.DesenharBorda(e, sender, 2, false, true, false, false, Color.Black);
        }
        ...
        private void GerarReceitasEmitidas(int index)
        {
            ...
            {
                int larguraLabel = PnlReceitasEmitidas.Width;
                ...
                PnlReceitasEmitidas.Controls.Add(label);
            }
        }
        ...
        {
            Boolean valido = true;
            foreach (var controle in new[] { TxtNomeFuncionario, TxtCPF, TxtCRM, TxtEmail, TxtSenha })
            {
