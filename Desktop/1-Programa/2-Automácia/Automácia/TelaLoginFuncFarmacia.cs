...
namespace Automácia
{
    public partial class TelaLoginFuncFarmacia : Form
    {
        ...
        public TelaLoginFuncFarmacia(Form form)
        {
            InitializeComponent();
        ...
        private void BtnEntrar_Click(object sender, EventArgs e)
        {
            ...
            if (cpf == "12345678910" && senha == "Senha123?")
            {
                ...
                objTelaVerificarReceitaFuncFarmacia.Show();
                this.Hide();
            }
            else
            {
        ...
        private void TelaLoginFuncFarmacia_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!Sessao.saindo)
            {
        ...
        private void TelaLoginFuncFarmacia_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
